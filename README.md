...
- **סטטוס:** המודל המאומן-מחדש הוא **מועמד v5 מחוץ ל-registry החי** — אימוץ, דגל-תחום לכיול, הגדרת תווית וגודל ארטיפקט (44MB) ממתינים להכרעת מנחה. `numbers.json` כולל בלוק `corpus_expansion_JPF`.
